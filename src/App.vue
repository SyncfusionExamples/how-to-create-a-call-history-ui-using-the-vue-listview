  ...
  <div class="listview-container">
    ...
    >
      ...
      <template v-slot:template="{data}">
          ...
          <span className="e-list-content"> {{  data.type }} {{  data.time }} </span>
        </div>
      </template>
      <template v-slot:groupTemplate="{data}">
        <span className="e-custom-group">{{data.items[0].time}}</span>
      </template>
    </ListViewComponent>
    </div>  
</template>
...
.listview-container {
  ...
  #listview.e-listview .e-list-header {
  color: white;
  height: 57px;
...
#listview.e-listview .e-headertext {
...
.e-listview.e-list-template
  .e-list-wrapper.e-list-mulit-line
  .e-list-item-header {
  color: #212529;
  display: block;
  font-size: 22px;
...
.e-listview.e-list-template .e-list-wrapper.e-list-mulit-line .e-list-content {
  color: #6c757d;
  display: block;
  font-size: 20px;
  font-weight: 400;
